...
const SuppliersTab = () => {
	...
	return (
		<div className="flex flex-col ">
			...
			<div className="flex mb-7 md:mb-16 items-start md:items-center flex-col md:flex-row gap-y-4">
				<p className="mr-3">Filter By:</p>
				<div className="flex flex-col md:flex-row gap-4 md:gap-6 md:justify-start w-full md:w-auto">
					<div className="relative">
						<select className="py-3 border border-black/[0.12] pl-2 md:pl-5 rounded-[10px] pr-14 w-full md:w-56 h-12 placeholder:font-medium text-[#0F0A19] md:placeholder:text-base placeholder:text-sm">
					...
					<div className="relative">
						<select
							...
							className="py-3 pl-2 md:pl-5 pr-14 rounded-[10px] w-full md:w-56 h-12 placeholder:font-medium text-[#0F0A19] border border-black/[0.12]"
						>
